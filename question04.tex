\begin{col-answer-preambule}
	...
	\begin{plan}
		...
		\item Доказательство:
		\subitem 3 свойства остатка ряда $R_n(x) = S(x) - S_n(x)$: Fun UFO (\textcolor{magenta}{F}u\textcolor{magenta}{n} UFO — функция непрерывна, Fu\textcolor{magenta}{n} \textcolor{magenta}{U}FO — последовательность убывает, Fun U\textcolor{magenta}{FO} — функция к 0).
		\subitem От противного показать, что это равномерная сходимость через правило де Моргана и принцип выбора (противоречие с последним свойством остатка).
