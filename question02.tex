...
\begin{notes}
	...
	\item Обобщая признак Вейерштрасса, где используется сходимость числовой мажоранты, - признак равомерной сходимости ФР, используют функцию мажоранты, а именно:
	\begin{equation*}
	 \text{если } \exists \; v_n(x) \geqslant 0 \; \text{| во-первых, } \sum  v_n(x)	 {\overset{X}\rightrightarrows} \text{, и, во-вторых, } \abs{u_n(x)} \leqslant v_n(x) \; \text{для } \forall \; n \in \mathbb{N} \text{ и для } \forall \; x \in X,
	 \end{equation*}
